      ...
      >
        <div className="mx-auto max-w-[1100px] px-6 flex items-center justify-between gap-4 py-5 text-primary-foreground">
          ...
          <div className="flex items-center gap-1">
            ...
            {/* Hamburger mobile */}
            <button
              className="md:hidden ml-2 p-1.5 text-foreground/70 hover:text-foreground transition-colors cursor-pointer bg-transparent border-0"
          ...
          >
            {navLinks.map((link) => (
              <a
                ...
                className="text-[0.78rem] tracking-[0.2em] uppercase text-foreground/70 hover:text-accent transition-colors py-1"
              >
                {link.label}
              </a>
            ))}
