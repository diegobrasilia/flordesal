  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1100px] px-6 py-14 md:py-20 max-w-2xl">
        ...
        <h1
          className="font-title text-[clamp(2.4rem,4vw,3.4rem)] leading-[1.1] mb-5 animate-fade-in-up"
          style={{ animationDelay: "0.1s", opacity: 0 }}
        >
          {t("Um lugar para desfrutar Mirandela", "A place to enjoy Mirandela")}
        </h1>
        <p
          className="text-foreground-muted max-w-[34rem] mb-8 animate-fade-in-up"
        ...
        <a
          href="#contact"
          className="inline-flex items-center justify-center px-7 py-3 rounded-full bg-accent text-accent-foreground text-[0.9rem] tracking-[0.15em] uppercase font-medium transition-all duration-200 hover:bg-accent-hover hover:-translate-y-0.5 animate-fade-in-up"
